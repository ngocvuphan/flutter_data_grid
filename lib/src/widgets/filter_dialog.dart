  ...
  Widget build(BuildContext context) {
    ...
    final filterConditionTypeItems =
      ...
      if (e != null) {
        return DropdownMenuItem<FilterConditionType>(
            value: e,
            child:
                Text(localization.filterConditionTypeDescription(e) ?? e.name));
      } else {
    ...
    final children = <Widget>[
      ...
      Padding(
        ...
        child: Text(localization.filterDialogSortTitle,
            style: const TextStyle(fontWeight: FontWeight.bold)),
      ),
      Padding(
        ...
        child: Row(
          ...
          children: [
            OutlinedButton.icon(
              ...
              label: Text(localization.dataGridSortStateDescription(
      ...
      Padding(
        padding: _kItemPadding,
        child: Text(localization.filterDialogFilterTitle,
            style: const TextStyle(fontWeight: FontWeight.bold)),
      ),
      Padding(
        padding: _kItemPadding,
